...
import { FaUser, FaBell, FaBook, FaEnvelope, FaTable } from 'react-icons/fa';
...
const CoordinatorPage: React.FC = () => {
    ...
    const handleLogout = () => {
        // Aqui você pode limpar os estados de autenticação ou fazer logout
    ...
    return (
        <div className="home-container">
            <header className="header">
                <h1 className="header-title">Painel do Coordenador</h1>
            ...
            <div className="grid-container">
                <div className="grid-item courses" onClick={() => navigate('/cursos')}>
                    ...
                    <h2>Cursos</h2>
                    <p>Veja todos os cursos gerenciados.</p>
                </div>
                ...
                <div className="grid-item schedule" onClick={() => navigate('/grade')}>
                <FaTable className="icon" />
                    <h2>Grade de Cursos</h2>
                    <p>Veja a grade de cursos por semestre.</p>
                </div>
            </div>
        </div>
    );
